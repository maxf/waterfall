...
var _user$project$Model$updatePhotoPath = F2(
	function (renamedPath, model) {
		var replacePath = F2(
			function (path, photo) {
				return _elm_lang$core$Native_Utils.eq(photo.relativeFilePath, path.old) ? _elm_lang$core$Native_Utils.update(
					photo,
					{relativeFilePath: path.$new}) : photo;
			});
		var updateInList = F3(
			function (path, _p26, list) {
				return A2(
					_elm_lang$core$List$map,
					replacePath(path),
					list);
	...
	function (fileName, _p29) {
		...
		return _user$project$Model$Model(
			_elm_lang$core$Native_Utils.update(
				_p31,
				{
					photoMetadata: A2(_user$project$Model$removePhotoFromDict, fileName, _p31.photoMetadata)
				}));
	});
...
var _user$project$Update$filenameFromUrl = function (location) {
	var matches = A3(
		_elm_lang$core$Regex$find,
		_elm_lang$core$Regex$AtMost(1),
		_elm_lang$core$Regex$regex('^#\\d{4}-\\d{2}-\\d{2}(.+)$'),
		location.hash);
	var _p0 = A2(
		_elm_lang$core$List$map,
		function (_) {
...
var _user$project$Update$dateFromUrl = function (location) {
	...
	var _p1 = fullDate;
	if (_p1.ctor === 'Ok') {
		return _user$project$Model$Date(_p1._0);
	} else {
		...
		switch (_p3.ctor) {
			...
			case 'UserAskedToDeleteAPhoto':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Update$deletePhoto(_p3._0)
				};
				...
				if (_p3._0.ctor === 'Ok') {
					...
					if (!_elm_lang$core$Native_Utils.eq(_p5, '')) {
						var hash = function () {
							...
							if (_p4.ctor === 'Date') {
								return _user$project$Update$hashForDate(_p4._0);
							} else {
								return '#';
							}
						}();
			...
			case 'PhotoWasRotated':
				if (_p3._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Model$updatePhotoPath, _p3._0._0, model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
