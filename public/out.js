...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Update.Msg":{"args":[],"tags":{"PhotoWasDeleted":["Result.Result Http.Error String"],"PhotoWasRotated":["Result.Result Http.Error String"],"UserClickedThumbnail":["Types.Photo"],"UserClickedPhoto":[],"GetAlbumsResult":["Maybe.Maybe Types.PhotoPath","Result.Result Http.Error (List String)"],"ScanPhotosResult":["Maybe.Maybe Types.PhotoPath","Result.Result Http.Error (List Types.Photo)"],"UserChangedAlbum":["Types.AlbumDir"],"ScrollPhotosFinished":[],"UrlHasChanged":["Navigation.Location"],"UserAskedToRotateAPhoto":["Int","Types.PhotoPath"],"UserAskedToDeleteAPhoto":["Types.PhotoPath"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Types.AlbumDir":{"args":[],"type":"String"},"Types.PhotoPath":{"args":[],"type":"String"},"Types.TimestampSeconds":{"args":[],"type":"Int"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"},"Types.Photo":{"args":[],"type":"{ relativeFilePath : Types.PhotoPath , dateCreated : Maybe.Maybe Types.TimestampSeconds }"}},"message":"Update.Msg"},"versions":{"elm":"0.18.0"}});
}
Elm['Model'] = Elm['Model'] || {};
