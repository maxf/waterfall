...
var _user$project$Model$Status = F4(
	function (a, b, c, d) {
		return {id: a, url: b, content: c, mediaAttachments: d};
	});
var _user$project$Model$Attachment = F3(
	function (a, b, c) {
...
var _user$project$Model$Gifv = {ctor: 'Gifv'};
var _user$project$Model$Video = {ctor: 'Video'};
...
var _user$project$Update$attachmentTypeDecoder = function (s) {
	...
	switch (_p2) {
		case 'image':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$Image);
		case 'video':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$Video);
		case 'gifv':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$Gifv);
		default:
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$Unknown);
	}
};
var _user$project$Update$mediaAttachmentDecoder = A3(
	...
	A3(
		...
		A3(
			...
			'id',
			_elm_lang$core$Json_Decode$string,
			_elm_lang$core$Json_Decode$succeed(_user$project$Model$Attachment))));
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'id',
				_elm_lang$core$Json_Decode$string,
				_elm_lang$core$Json_Decode$succeed(_user$project$Model$Status)))));
var _user$project$Update$timelineDecoder = _elm_lang$core$Json_Decode$list(_user$project$Update$statusDecoder);
var _user$project$Update$AuthResponse = function (a) {
	return {token: a};
};
var _user$project$Update$oauthResponseDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'access_token',
	_elm_lang$core$Json_Decode$string,
	_elm_lang$core$Json_Decode$succeed(_user$project$Update$AuthResponse));
var _user$project$Update$CloseMessage = {ctor: 'CloseMessage'};
var _user$project$Update$TimelineFetched = function (a) {
...
var _user$project$Update$getTimeline = F2(
	function (instanceUrl, authToken) {
		...
		return A2(_elm_lang$http$Http$send, _user$project$Update$TimelineFetched, request);
	});
var _user$project$Update$AuthReturn = function (a) {
...
var _user$project$Update$authenticate = function (model) {
	...
	var request = A3(
		...
		_user$project$Update$oauthResponseDecoder);
	return A2(_elm_lang$http$Http$send, _user$project$Update$AuthReturn, request);
};
			...
			case 'AuthReturn':
				if (_p3._0.ctor === 'Ok') {
					...
					return {
						...
						_1: A2(_user$project$Update$getTimeline, model.instanceUrl, _p4.token)
					};
				} else {
					return {
						ctor: '_Tuple2',
...
var _user$project$Update$AuthSubmit = {ctor: 'AuthSubmit'};
var _user$project$Update$InstanceUrl = function (a) {
	return {ctor: 'InstanceUrl', _0: a};
};
var _user$project$Update$Password = function (a) {
	return {ctor: 'Password', _0: a};
};
var _user$project$Update$Username = function (a) {
		...
		if (_p1.ctor === 'Nothing') {
			...
			return A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Update$CloseMessage),
						_1: {ctor: '[]'}
					}
				},
				{
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Update$AuthSubmit),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
