			...
			if (_p2.ctor === 'Nothing') {
				...
				return {
					...
					_0: A2(
						_elm_lang$http$Http$header,
						'Authorization',
						A2(_elm_lang$core$Basics_ops['++'], 'Bearer ', _p2._0)),
					_1: {ctor: '[]'}
				};
			}
		}();
				...
				if (_p4._0.ctor === 'Ok') {
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								authToken: _elm_lang$core$Maybe$Just(_p5.token),
								message: _elm_lang$core$Maybe$Nothing
							}),
						{
							ctor: '::',
							_0: _user$project$Auth$storeAuthToken(_p5.token),
							_1: {
								ctor: '::',
								_0: A2(_user$project$Update$getUser, _p5.token, model.instanceUrl),
								_1: {ctor: '[]'}
							}
						});
				} else {
							...
							model,
							{
								message: _elm_lang$core$Maybe$Just(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'auth error: ',
										_user$project$Update$httpErrorMessage(_p4._0._0)))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			case 'AuthTokenRetrieved':
				...
				if (_p7.ctor === 'Nothing') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{authToken: _p8, password: ''}),
						_1: A2(_user$project$Update$getUser, _p7._0, model.instanceUrl)
					};
				}
			case 'UrlHasChanged':
