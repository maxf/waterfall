...
var author$project$Types$AuthResponse = function (token) {
	return {token: token};
};
var elm$json$Json$Decode$string = _Json_decodeString;
var elm$json$Json$Decode$succeed = _Json_succeed;
var author$project$Auth$oauthResponseDecoder = A3(
...
var author$project$Types$AuthReturn = function (a) {
	return {$: 'AuthReturn', a: a};
};
...
var author$project$Main$QueryStringParams = F2(
	function (code, state) {
...
var author$project$Main$queryStringParser = A3(
	elm$url$Url$Parser$Query$map2,
	author$project$Main$QueryStringParams,
...
var author$project$Main$codeIdentityParser = A2(
	elm$url$Url$Parser$slash,
	elm$url$Url$Parser$top,
	A2(
		elm$url$Url$Parser$slash,
		elm$url$Url$Parser$query(author$project$Main$queryStringParser),
...
var author$project$Main$urlParser = A2(elm$url$Url$Parser$map, author$project$Main$UrlData, author$project$Main$codeIdentityParser);
...
var author$project$Main$queryStringAndFragment = function (url) {
	return A2(
		elm$url$Url$Parser$parse,
		author$project$Main$urlParser,
		_Utils_update(
			url,
			{path: ''}));
};
...
var author$project$Model$initialModel = F2(
	function (key, url) {
		return {authCode: elm$core$Maybe$Nothing, authToken: elm$core$Maybe$Nothing, currentStatus: elm$core$Maybe$Nothing, currentUrl: url, key: key, message: elm$core$Maybe$Nothing, otherUserId: elm$core$Maybe$Nothing, otherUsername: elm$core$Maybe$Nothing, server: author$project$Types$defaultServer, shareText: '', timeline: _List_Nil, userAvatar: elm$core$Maybe$Nothing, userEmail: elm$core$Maybe$Nothing, userId: elm$core$Maybe$Nothing, username: elm$core$Maybe$Nothing, view: author$project$Types$StartingPage};
	});
...
var author$project$Types$StatusPage = function (a) {
...
var author$project$Types$StatusId = function (a) {
	return {$: 'StatusId', a: a};
};
...
var author$project$Types$photoUrlRegex = A2(
	elm$core$Maybe$withDefault,
	elm$regex$Regex$never,
	elm$regex$Regex$fromString('photo:([^:]+):(.*)'));
var elm$regex$Regex$find = _Regex_findAtMost(_Regex_infinity);
var author$project$Types$photoHashParts = function (hash) {
	var _n0 = A2(elm$regex$Regex$find, author$project$Types$photoUrlRegex, hash);
	if (_n0.b && (!_n0.b.b)) {
		var match = _n0.a;
		var _n1 = match.submatches;
		if ((((_n1.b && (_n1.a.$ === 'Just')) && _n1.b.b) && (_n1.b.a.$ === 'Just')) && (!_n1.b.b.b)) {
			var photoId = _n1.a.a;
			var _n2 = _n1.b;
			var attachmentId = _n2.a.a;
			return elm$core$Result$Ok(
				_Utils_Tuple2(
					author$project$Types$StatusId(photoId),
					author$project$Types$AttachmentId(attachmentId)));
		} else {
			return elm$core$Result$Err('no photo URL parts matched');
		}
	} else {
...
var author$project$Types$userIdFromWebFinger = function (list) {
	return A2(
		elm$core$Maybe$map,
		author$project$Types$userIdFromSalmonUrl,
		A2(
			elm$core$Maybe$map,
			function ($) {
				return $.href;
...
var author$project$Types$WebFingerRel = F2(
	function (rel, href) {
		return {href: href, rel: rel};
	});
var author$project$Types$webFingerRelDecoder = A4(
...
var author$project$Types$webFingerDecoder = A2(
	...
	A2(
		...
		'links',
		elm$json$Json$Decode$list(author$project$Types$webFingerRelDecoder)));
var elm$http$Http$emptyBody = _Http_emptyBody;
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{body: elm$http$Http$emptyBody, expect: r.expect, headers: _List_Nil, method: 'GET', timeout: elm$core$Maybe$Nothing, tracker: elm$core$Maybe$Nothing, url: r.url});
};
var author$project$Update$fetchOtherUserId = F2(
	function (instanceUrl, acct) {
		...
		return elm$http$Http$get(
			{
				expect: A2(elm$http$Http$expectJson, author$project$Types$ReceivedOtherUserId, author$project$Types$webFingerDecoder),
				url: elm$url$Url$toString(url)
			});
	});
var author$project$Types$StatusFetched = function (a) {
	return {$: 'StatusFetched', a: a};
};
var author$project$Types$Status = F8(
	function (id, url, account, content, attachments, sensitive, favouritesCount, reblogsCount) {
		return {account: account, attachments: attachments, content: content, favouritesCount: favouritesCount, id: id, reblogsCount: reblogsCount, sensitive: sensitive, url: url};
	});
var author$project$Types$Account = F4(
	function (id, acct, displayName, avatarUrl) {
		return {acct: acct, avatarUrl: avatarUrl, displayName: displayName, id: id};
	});
...
var author$project$Types$attachmentIdDecoder = A2(
	elm$json$Json$Decode$map,
	function (s) {
		return author$project$Types$AttachmentId(s);
	},
	elm$json$Json$Decode$string);
var author$project$Types$Gifv = {$: 'Gifv'};
var author$project$Types$Image = {$: 'Image'};
var author$project$Types$Unknown = {$: 'Unknown'};
var author$project$Types$Video = {$: 'Video'};
var author$project$Types$attachmentTypeDecoder = function (s) {
	switch (s) {
		case 'image':
			return elm$json$Json$Decode$succeed(author$project$Types$Image);
		case 'video':
			return elm$json$Json$Decode$succeed(author$project$Types$Video);
		case 'gifv':
			return elm$json$Json$Decode$succeed(author$project$Types$Gifv);
		default:
			return elm$json$Json$Decode$succeed(author$project$Types$Unknown);
	}
};
var author$project$Types$attachmentDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'preview_url',
	elm$json$Json$Decode$string,
	A3(
		...
		A3(
			NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'type',
			A2(elm$json$Json$Decode$andThen, author$project$Types$attachmentTypeDecoder, elm$json$Json$Decode$string),
			A3(
				NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
				'id',
				author$project$Types$attachmentIdDecoder,
				elm$json$Json$Decode$succeed(author$project$Types$Attachment)))));
var author$project$Types$statusIdDecoder = A2(
	elm$json$Json$Decode$map,
	function (s) {
		return author$project$Types$StatusId(s);
	},
	elm$json$Json$Decode$string);
...
var author$project$Types$statusDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'reblogs_count',
	...
	A3(
		...
		A3(
			...
			A3(
				NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
				'media_attachments',
				elm$json$Json$Decode$list(author$project$Types$attachmentDecoder),
				A4(
					NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
					'content',
		...
		return elm$http$Http$request(
			{
				...
				expect: A2(elm$http$Http$expectJson, author$project$Types$StatusFetched, author$project$Types$statusDecoder),
				headers: headers,
				method: 'GET',
	...
	function (instanceUrl, authToken, pageType) {
		var urlPath = function () {
			if (pageType.$ === 'UserPage') {
				var userId = pageType.a;
				return '/api/v1/accounts/' + (userId + '/statuses');
			} else {
		...
		var url = _Utils_update(
			...
			{
				path: urlPath,
				query: elm$core$Maybe$Just('limit=40&local=true')
			});
		var headers = function () {
			if (authToken.$ === 'Nothing') {
				return _List_Nil;
	...
	if (_n0.$ === 'Nothing') {
		...
		if (_n0.a === 'logout') {
			...
			if (A2(elm$core$String$startsWith, 'user:', frag)) {
				...
				if (A2(elm$core$String$startsWith, 'status:', frag)) {
					var statusId = author$project$Types$StatusId(
						A2(elm$core$String$dropLeft, 7, frag));
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 'UserDetailsFetched':
				if (msg.a.$ === 'Err') {
					...
					var newModel = _Utils_update(
						model,
						{
							userAvatar: elm$core$Maybe$Just(account.avatarUrl),
	...
	return elm$http$Http$request(
		{
			...
			expect: elm$http$Http$expectString(
				A2(elm$core$Basics$composeL, author$project$Types$Share, author$project$Types$ImageShared)),
			headers: _List_Nil,
			method: 'POST',
			timeout: elm$core$Maybe$Nothing,
			tracker: elm$core$Maybe$Nothing,
...
var author$project$Ports$fileUpload = _Platform_outgoingPort(
	'fileUpload',
	function ($) {
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'inputElementId',
					elm$json$Json$Encode$string($.inputElementId)),
					_Utils_Tuple2(
					'serverUrl',
...
var author$project$Update$uploadImage = function (model) {
	return author$project$Ports$fileUpload(
		{
...
var author$project$Update$updateShare = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ShareTextInput':
				var text = msg.a;
			...
			case 'ShareImage':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							message: elm$core$Maybe$Just('Uploading image')
						}),
					author$project$Update$shareImage(model));
			case 'UploadImage':
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					author$project$Update$uploadImage(model));
			case 'StatusPosted':
				if (msg.a.$ === 'Nothing') {
					var _n1 = msg.a;
					return _Utils_Tuple2(
			...
			case 'ImageSelected':
				return _Utils_Tuple2(
					model,
					author$project$Ports$getImageFromForm('file-upload'));
			case 'FormImageRead':
				var imageData = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							view: author$project$Types$ShareUploadPage(
								elm$core$Maybe$Just(imageData.contents))
						}),
					elm$core$Platform$Cmd$none);
			default:
				if (msg.a.$ === 'Err') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								message: elm$core$Maybe$Just(
									'share error: ' + author$project$Update$httpErrorMessage(error))
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
...
var author$project$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Auth':
				var authMsg = msg.a;
				return A2(author$project$Update$updateAuth, authMsg, model);
			case 'Share':
				var shareMsg = msg.a;
				return A2(author$project$Update$updateShare, shareMsg, model);
			case 'TimelineFetched':
				if (msg.a.$ === 'Ok') {
					var timeline = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								message: elm$core$Maybe$Just(
									'timeline error: ' + author$project$Update$httpErrorMessage(e))
							}),
						elm$core$Platform$Cmd$none);
				}
			case 'StatusFetched':
				if (msg.a.$ === 'Err') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								currentStatus: elm$core$Maybe$Just(status)
							}),
						elm$core$Platform$Cmd$none);
				}
			case 'CloseMessage':
			...
			case 'ViewPhoto':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							view: A2(author$project$Types$PhotoPage, status.id, attachment.id)
						}),
					A2(
			...
			case 'ViewStatus':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							view: author$project$Types$StatusPage(status.id)
						}),
					A2(
						elm$browser$Browser$Navigation$pushUrl,
						model.key,
						'#status:' + author$project$Types$statusIdToString(status.id)));
			case 'UrlHasChanged':
				var location = msg.a;
				var newModel = _Utils_update(
					model,
					...
					if (userId.$ === 'Nothing') {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									view: author$project$Types$ErrorPage('User not found')
								}),
							elm$core$Platform$Cmd$none);
					} else {
						var id = userId.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									otherUserId: elm$core$Maybe$Just(id),
									view: author$project$Types$UserPage(id)
								}),
							A3(
								author$project$Update$getTimeline,
								model.server.url,
								model.authToken,
								author$project$Types$UserPage(id)));
					}
				} else {
					var message = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								view: author$project$Types$ErrorPage(
									author$project$Update$httpErrorMessage(message))
							}),
						elm$core$Platform$Cmd$none);
				}
		}
...
var author$project$View$nothing = elm$html$Html$text('');
...
var author$project$View$viewThumbnailContent = function (content) {
	if (content.$ === 'Nothing') {
...
var author$project$View$viewPhoto = F2(
	function (status, attachmentId) {
		var attachment = A2(
			elm$core$List$filter,
			function (a) {
				return _Utils_eq(a.id, attachmentId);
			},
			status.attachments);
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								markup,
								author$project$View$viewThumbnailContent(status.content)
							]))
					]));
		} else {
			return A2(elm$html$Html$div, _List_Nil, _List_Nil);
...
var author$project$Types$ShareImage = {$: 'ShareImage'};
var author$project$Types$ShareTextInput = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Share photo')
					])),
				A2(
				elm$html$Html$img,
				_List_fromArray(
					[
						elm$html$Html$Attributes$src('/thumb?photo=' + path)
					]),
				_List_Nil),
				...
				_List_fromArray(
					[
						...
						A2(elm$core$Basics$composeL, author$project$Types$Share, author$project$Types$ShareTextInput)),
				...
				_List_fromArray(
					[
						...
						author$project$Types$Share(author$project$Types$ShareImage))
					]),
				_List_fromArray(
					[
...
var author$project$Types$ImageSelected = {$: 'ImageSelected'};
var author$project$View$viewShareUpload = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('share')
			...
			_List_fromArray(
				[
					...
					elm$json$Json$Decode$succeed(
						author$project$Types$Share(author$project$Types$ImageSelected)))
				]),
			_List_Nil)
		]));
var author$project$Types$UploadImage = {$: 'UploadImage'};
var author$project$View$viewShareUploaded = function (dataUrl) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(
						author$project$Types$Share(author$project$Types$UploadImage))
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Share')
...
var author$project$View$viewStatusAttachment = function (attachment) {
	return A2(
		elm$html$Html$img,
		_List_fromArray(
			[
...
var author$project$View$viewStatusContent = function (status) {
	var user = A2(
		elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
	...
	var reblogs = status.reblogsCount ? A2(
		elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				elm$html$Html$text(
				'🔁' + elm$core$String$fromInt(status.reblogsCount))
			])) : author$project$View$nothing;
	var favourites = status.favouritesCount ? A2(
		elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				elm$html$Html$text(
				'❤️' + elm$core$String$fromInt(status.favouritesCount))
			])) : author$project$View$nothing;
	var content = function () {
		var _n0 = status.content;
		if (_n0.$ === 'Nothing') {
			return author$project$View$nothing;
		} else {
			var message = _n0.a;
			return A2(
				elm$html$Html$li,
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						author$project$View$stripTags(message))
					]));
		}
	}();
	return A2(
...
var author$project$View$viewStatus = function (status) {
	return A2(
		...
		status.sensitive ? _List_fromArray(
			...
			elm$core$List$cons,
			author$project$View$viewStatusContent(status),
...
var author$project$View$viewAttachment = F2(
	function (statusId, attachment) {
		...
		if (_n0.$ === 'Unknown') {
			...
			var attachmentHref = '#status:' + author$project$Types$statusIdToString(statusId);
			return A2(
				elm$html$Html$a,
				_List_fromArray(
					[
...
var author$project$View$viewThumbnailCaption = F2(
	function (pageType, status) {
		...
		return A2(
			...
			_List_fromArray(
				[userName, attachmentCount, favourites, reblogs]));
	});
var author$project$View$viewThumbnail = F2(
	function (pageType, status) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					A2(author$project$View$viewThumbnailCaption, pageType, status)
				]));
	});
var author$project$View$viewTimeline = F2(
	function (timeline, pageType) {
		var statusesWithAttachments = A2(
			elm$core$List$filter,
			function (s) {
				return !_Utils_eq(s.attachments, _List_Nil);
			},
		...
		return A2(
			...
			A2(
				elm$core$List$map,
				author$project$View$viewThumbnail(pageType),
...
var author$project$View$viewMain = function (model) {
	...
	switch (_n0.$) {
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Welcome to Waterfall')
							])),
						A2(
						elm$html$Html$p,
						_List_Nil,
		...
		case 'StatusPage':
			var _n1 = model.currentStatus;
			if (_n1.$ === 'Nothing') {
				return author$project$View$nothing;
			} else {
				var status = _n1.a;
				return author$project$View$viewStatus(status);
			}
		case 'PhotoPage':
			var attachmentId = _n0.b;
			var _n2 = _Utils_Tuple2(model.currentStatus, attachmentId);
			if (_n2.a.$ === 'Just') {
				var status = _n2.a.a;
				var photoId = _n2.b;
				return A2(author$project$View$viewPhoto, status, photoId);
			} else {
				return A2(elm$html$Html$div, _List_Nil, _List_Nil);
			}
		case 'SharePathPage':
		...
		case 'HomePage':
			var title = A2(elm$core$Maybe$withDefault, '', model.username) + '\'s home';
			return A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									A2(elm$core$Maybe$withDefault, '', model.userAvatar))
								]),
							_List_Nil),
							A2(
							elm$html$Html$span,
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$href('#public')
										]),
									_List_fromArray(
										[
											elm$html$Html$text('Public photos')
										]))
								])),
							A2(
							elm$html$Html$li,
...
var author$project$View$view = function (model) {
	var message = function () {
		...
		if (_n0.$ === 'Nothing') {
			...
			var messageText = _n0.a;
			return A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('error'),
						elm$html$Html$Events$onClick(author$project$Types$CloseMessage)
					]),
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$id('photos')
									]),
								_List_fromArray(
									[
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Types.Msg","aliases":{"Types.Account":{"args":[],"type":"{ id : String.String, acct : String.String, displayName : String.String, avatarUrl : String.String }"},"Types.Attachment":{"args":[],"type":"{ id : Types.AttachmentId, type_ : Types.AttachmentType, url : String.String, previewUrl : String.String }"},"Types.Status":{"args":[],"type":"{ id : Types.StatusId, url : Maybe.Maybe String.String, account : Types.Account, content : Maybe.Maybe String.String, attachments : List.List Types.Attachment, sensitive : Basics.Bool, favouritesCount : Basics.Int, reblogsCount : Basics.Int }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Types.AuthResponse":{"args":[],"type":"{ token : String.String }"},"Types.ImagePortData":{"args":[],"type":"{ contents : String.String, filename : String.String }"}},"unions":{"Types.Msg":{"args":[],"tags":{"Auth":["Types.AuthMsg"],"Share":["Types.ShareMsg"],"TimelineFetched":["Result.Result Http.Error (List.List Types.Status)"],"StatusFetched":["Result.Result Http.Error Types.Status"],"CloseMessage":[],"ViewStatus":["Types.Status"],"ViewPhoto":["Types.Status","Types.Attachment"],"UrlHasChanged":["Url.Url"],"LinkWasClicked":["Browser.UrlRequest"],"UserClickedLogin":[],"ReceivedOtherUserId":["Result.Result Http.Error (Maybe.Maybe String.String)"]}},"Types.AttachmentId":{"args":[],"tags":{"AttachmentId":["String.String"]}},"Types.AttachmentType":{"args":[],"tags":{"Image":[],"Video":[],"Gifv":[],"Unknown":[]}},"Types.AuthMsg":{"args":[],"tags":{"ServerSelect":["String.String"],"AuthSubmit":[],"AuthReturn":["Result.Result Http.Error Types.AuthResponse"],"UserDetailsFetched":["Result.Result Http.Error Types.Account"],"AuthTokenRetrievedFromLocalStorage":["( String.String, Maybe.Maybe String.String )"]}},"Types.ShareMsg":{"args":[],"tags":{"ShareTextInput":["String.String"],"ShareImage":[],"UploadImage":[],"StatusPosted":["Maybe.Maybe String.String"],"ImageSelected":[],"FormImageRead":["Types.ImagePortData"],"ImageShared":["Result.Result Http.Error String.String"]}},"Types.StatusId":{"args":[],"tags":{"StatusId":["String.String"]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}}}}})}});}(this));