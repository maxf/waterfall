...
var _user$project$Types$attachmentIdToString = function (_p0) {
	var _p1 = _p0;
	return _p1._0;
};
var _user$project$Types$statusIdToString = function (_p2) {
	var _p3 = _p2;
	return _p3._0;
};
...
var _user$project$Types$ImagePortData = F2(
	function (a, b) {
...
var _user$project$Types$Status = F5(
	function (a, b, c, d, e) {
		return {id: a, url: b, account: c, content: d, attachments: e};
	});
var _user$project$Types$Attachment = F4(
	function (a, b, c, d) {
		return {id: a, type_: b, url: c, previewUrl: d};
	});
var _user$project$Types$Logout = {ctor: 'Logout'};
var _user$project$Types$AuthTokenRetrievedFromLocalStorage = function (a) {
	return {ctor: 'AuthTokenRetrievedFromLocalStorage', _0: a};
};
var _user$project$Types$UserDetailsFetched = function (a) {
	return {ctor: 'UserDetailsFetched', _0: a};
};
var _user$project$Types$AuthReturn = function (a) {
...
var _user$project$Types$UserEmail = function (a) {
...
var _user$project$Types$ShareTextInput = function (a) {
	return {ctor: 'ShareTextInput', _0: a};
};
...
var _user$project$Types$PhotoFetched = function (a) {
	return {ctor: 'PhotoFetched', _0: a};
};
...
var _user$project$Types$StatusId = function (a) {
	return {ctor: 'StatusId', _0: a};
};
var _user$project$Types$statusIdDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	function (s) {
		return _user$project$Types$StatusId(s);
	},
	_elm_lang$core$Json_Decode$string);
var _user$project$Types$Unknown = {ctor: 'Unknown'};
var _user$project$Types$Gifv = {ctor: 'Gifv'};
var _user$project$Types$Video = {ctor: 'Video'};
var _user$project$Types$Image = {ctor: 'Image'};
var _user$project$Types$attachmentTypeDecoder = function (s) {
	var _p4 = s;
	switch (_p4) {
		case 'image':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Types$Image);
		case 'video':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Types$Video);
		case 'gifv':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Types$Gifv);
		default:
			return _elm_lang$core$Json_Decode$succeed(_user$project$Types$Unknown);
	}
};
var _user$project$Types$AttachmentId = function (a) {
	return {ctor: 'AttachmentId', _0: a};
};
var _user$project$Types$attachmentIdDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	function (s) {
		return _user$project$Types$AttachmentId(s);
	},
	_elm_lang$core$Json_Decode$string);
var _user$project$Types$attachmentDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'preview_url',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'type',
			A2(_elm_lang$core$Json_Decode$andThen, _user$project$Types$attachmentTypeDecoder, _elm_lang$core$Json_Decode$string),
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'id',
				_user$project$Types$attachmentIdDecoder,
				_elm_lang$core$Json_Decode$succeed(_user$project$Types$Attachment)))));
var _user$project$Types$statusDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'media_attachments',
	_elm_lang$core$Json_Decode$list(_user$project$Types$attachmentDecoder),
	A4(
...
var _user$project$Ports$localStorageGetItem = _elm_lang$core$Native_Platform.outgoingPort(
	'localStorageGetItem',
	function (v) {
		return v;
	});
					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {server: a, authToken: b, userEmail: c, userId: d, password: e, message: f, timeline: g, screenShown: h, shareText: i, currentStatus: j};
									};
								};
							};
						};
...
var _user$project$Auth$oauthResponseDecoder = A3(
	...
	'access_token',
	_elm_lang$core$Json_Decode$string,
	_elm_lang$core$Json_Decode$succeed(_user$project$Types$AuthResponse));
var _user$project$Auth$authenticate = function (model) {
	var postParams = A2(
		_elm_lang$core$Basics_ops['++'],
		'client_id=',
		A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$http$Http$encodeUri(model.userEmail),
					A2(
						_elm_lang$core$Basics_ops['++'],
	...
	return A2(
		...
		function (_p0) {
			return _user$project$Types$Auth(
				_user$project$Types$AuthReturn(_p0));
		},
		request);
};
...
var _user$project$View$viewShareUploaded = function (dataUrl) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Upload photo'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
							...
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Events$onInput(
										function (_p0) {
											return _user$project$Types$Share(
												_user$project$Types$ShareTextInput(_p0));
										}),
									_1: {
										ctor: '::',
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Types$Share(_user$project$Types$UploadImage)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
...
var _user$project$View$viewShareUpload = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('share'),
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Select photo'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								'change',
								_elm_lang$core$Json_Decode$succeed(
									_user$project$Types$Share(_user$project$Types$ImageSelected))),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _user$project$View$viewSharePath = function (path) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Share photo'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$img,
					{
						...
						_0: _elm_lang$html$Html_Attributes$src(
							A2(_elm_lang$core$Basics_ops['++'], '/thumb?photo=', path)),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
							...
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Events$onInput(
										function (_p1) {
											return _user$project$Types$Share(
												_user$project$Types$ShareTextInput(_p1));
										}),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$placeholder('title'),
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Types$Share(_user$project$Types$ShareImage)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
	...
	if (_p3.ctor === 'Nothing') {
		...
		return A2(
			_elm_lang$html$Html$main_,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_community$html_extra$Html_Attributes_Extra$innerHtml(_p3._0),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'});
									...
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(model.userEmail),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$View$viewPhoto = F2(
	function (status, attachmentId) {
		var attachment = A2(
			_elm_lang$core$List$filter,
			function (a) {
				return _elm_lang$core$Native_Utils.eq(a.id, attachmentId);
			},
			status.attachments);
		var _p7 = attachment;
				...
				switch (_p8.ctor) {
					case 'Image':
						return A2(
							_elm_lang$html$Html$img,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$src(_p9.url),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'});
					...
					default:
						return A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Can\'t show this content'),
								_1: {ctor: '[]'}
							});
				}
			}();
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Public timeline'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], 'User', _p10._0)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Your pictures'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _user$project$View$viewSidebarLinks = function (userId) {
	var _p15 = userId;
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(_elm_lang$core$Basics_ops['++'], 'You are: ', _p15._0)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$span,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Types$Auth(_user$project$Types$Logout)),
										_1: {
											ctor: '::',
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Timeline'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$href('#upload'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
...
var _user$project$View$viewSidebar = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$View$viewSidebarLinks(model.userId),
				_1: {ctor: '[]'}
			}
		});
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$View$viewSidebar(model),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
...
var _user$project$Update$shareImage = function (model) {
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(_elm_lang$core$Basics_ops['++'], '&path=', imagePath))))))));
	...
	return A2(
		...
		function (_p1) {
			return _user$project$Types$Share(
				_user$project$Types$ImageShared(_p1));
		},
		request);
};
...
var _user$project$Update$fetchCurrentUserDetails = F2(
	function (authToken, instanceUrl) {
		return A2(
			_elm_lang$http$Http$send,
			function (_p2) {
				return _user$project$Types$Auth(
					_user$project$Types$UserDetailsFetched(_p2));
			},
...
var _user$project$Update$httpErrorMessage = function (error) {
	...
	switch (_p3.ctor) {
		...
		case 'BadStatus':
			...
			return A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(_p4.status.code),
				A2(
					_elm_lang$core$Basics_ops['++'],
					' (',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_p4.status.message,
						A2(_elm_lang$core$Basics_ops['++'], ') - ', _p4.body))));
		default:
			...
			switch (_p6.ctor) {
				...
				case 'User':
					return A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$http$Http$encodeUri(_p6._0),
							'/statuses'));
				default:
		...
		var request = _elm_lang$http$Http$request(
			{
				...
				url: A2(
					_elm_lang$core$Basics_ops['++'],
					instanceUrl,
					A2(_elm_lang$core$Basics_ops['++'], urlPath, '?limit=40')),
				body: _elm_lang$http$Http$emptyBody,
				expect: _elm_lang$http$Http$expectJson(_user$project$Types$timelineDecoder),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
		return A2(_elm_lang$http$Http$send, _user$project$Types$TimelineFetched, request);
	});
var _user$project$Update$getStatus = F3(
	function (instanceUrl, authToken, _p7) {
		var _p8 = _p7;
		var headers = function () {
			var _p9 = authToken;
			if (_p9.ctor === 'Nothing') {
				...
				return {
					...
					_0: A2(
						_elm_lang$http$Http$header,
						'Authorization',
						A2(_elm_lang$core$Basics_ops['++'], 'Bearer ', _p9._0)),
					_1: {ctor: '[]'}
				};
			}
		}();
		var request = _elm_lang$http$Http$request(
			{
				...
				url: A2(
					_elm_lang$core$Basics_ops['++'],
					instanceUrl,
					A2(_elm_lang$core$Basics_ops['++'], '/api/v1/statuses/', _p8._0)),
				body: _elm_lang$http$Http$emptyBody,
				expect: _elm_lang$http$Http$expectJson(_user$project$Types$statusDecoder),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
		return A2(_elm_lang$http$Http$send, _user$project$Types$PhotoFetched, request);
	});
var _user$project$Update$photoUrlRegex = _elm_lang$core$Regex$regex('#photo:([^:]+):(.*)');
var _user$project$Update$photoHashParts = function (hash) {
	var matches = A3(
		_elm_lang$core$Regex$find,
		_elm_lang$core$Regex$AtMost(1),
		_user$project$Update$photoUrlRegex,
		hash);
	var _p10 = matches;
	if ((_p10.ctor === '::') && (_p10._1.ctor === '[]')) {
		var _p11 = _p10._0.submatches;
		if (((((_p11.ctor === '::') && (_p11._0.ctor === 'Just')) && (_p11._1.ctor === '::')) && (_p11._1._0.ctor === 'Just')) && (_p11._1._1.ctor === '[]')) {
			return _elm_lang$core$Result$Ok(
				{
					ctor: '_Tuple2',
					_0: _user$project$Types$StatusId(_p11._0._0),
					_1: _user$project$Types$AttachmentId(_p11._1._0._0)
				});
		} else {
			return _elm_lang$core$Result$Err('no photo URL parts matched');
		}
	} else {
		return _elm_lang$core$Result$Err('no matches found in photo URL');
	}
};
		...
		case 'User':
			...
			if (_p15.ctor === 'Nothing') {
				...
				return A3(
					...
					model.server.url,
					_p15,
					_user$project$Types$User(_p12._0));
			}
		case 'Home':
			...
			if (_p17.ctor === 'Nothing') {
				...
				if (_p18.ctor === 'Nothing') {
					...
					return A3(
						...
						model.server.url,
						model.authToken,
						_user$project$Types$User(_p18._0));
				}
			}
		default:
			return A3(_user$project$Update$getTimeline, model.server.url, model.authToken, _p12);
	}
};
var _user$project$Update$screenType = function (url) {
	if (_elm_lang$core$Native_Utils.eq(url.hash, '') || _elm_lang$core$Native_Utils.eq(url.hash, '#')) {
		return _user$project$Types$PublicTimeline;
	} else {
		if (_elm_lang$core$Native_Utils.eq(url.hash, '#login')) {
...
var _user$project$Update$updateShare = F2(
	function (msg, model) {
		var _p20 = msg;
		switch (_p20.ctor) {
			case 'ShareTextInput':
				...
				if (_p20._0.ctor === 'Nothing') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								message: _elm_lang$core$Maybe$Just(_p20._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
							...
							model,
							{
								message: _elm_lang$core$Maybe$Just(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'share error: ',
										_user$project$Update$httpErrorMessage(_p20._0._0)))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _user$project$Update$updateAuth = F2(
	function (msg, model) {
		var _p21 = msg;
		switch (_p21.ctor) {
			case 'UserEmail':
			...
			case 'ServerSelect':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Model$changeServerUrl, model, _p21._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AuthSubmit':
				return {
				...
				if (_p21._0.ctor === 'Err') {
							...
							model,
							{
								message: _elm_lang$core$Maybe$Just(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'auth error: ',
										_user$project$Update$httpErrorMessage(_p21._0._0)))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								authToken: _elm_lang$core$Maybe$Just(_p22.token),
								message: _elm_lang$core$Maybe$Nothing
							}),
						{
							ctor: '::',
							_0: _user$project$Auth$storeAuthToken(_p22.token),
							_1: {
								ctor: '::',
								_0: A2(_user$project$Update$fetchCurrentUserDetails, _p22.token, model.server.url),
								_1: {ctor: '[]'}
							}
						});
				}
			case 'UserDetailsFetched':
				if (_p21._0.ctor === 'Err') {
					...
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{
							userId: _elm_lang$core$Maybe$Just(_p21._0._0.id)
						});
					return {
						ctor: '_Tuple2',
						_0: newModel,
			...
			case 'AuthTokenRetrievedFromLocalStorage':
				var _p24 = _p21._0._1;
				var _p23 = _p24;
				if (_p23.ctor === 'Nothing') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{authToken: _p24, password: ''}),
						_1: A2(_user$project$Update$fetchCurrentUserDetails, _p23._0, model.server.url)
					};
				}
			default:
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{authToken: _elm_lang$core$Maybe$Nothing, userId: _elm_lang$core$Maybe$Nothing, userEmail: ''}),
					{
						ctor: '::',
						_0: _user$project$Auth$clearAuthToken,
						_1: {
							ctor: '::',
							_0: _elm_lang$navigation$Navigation$modifyUrl('#public'),
							_1: {ctor: '[]'}
						}
					});
		}
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p25.ctor) {
			case 'Auth':
				return A2(_user$project$Update$updateAuth, _p25._0, model);
			case 'Share':
				return A2(_user$project$Update$updateShare, _p25._0, model);
							...
							model,
							{
								message: _elm_lang$core$Maybe$Just(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'timeline error: ',
										_user$project$Update$httpErrorMessage(_p25._0._0)))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
				...
				if (_p25._0.ctor === 'Err') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								currentStatus: _elm_lang$core$Maybe$Just(_p25._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			case 'ViewPhoto':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							screenShown: A2(_user$project$Types$Photo, _p27.id, _p26.id)
						}),
					_1: _elm_lang$navigation$Navigation$newUrl(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$Types$statusIdToString(_p27.id),
								A2(
									_elm_lang$core$Basics_ops['++'],
									':',
									_user$project$Types$attachmentIdToString(_p26.id)))))
				};
			default:
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						screenShown: _user$project$Update$screenType(_p25._0)
					});
				return {
					ctor: '_Tuple2',
					_0: newModel,
...
var _user$project$Main$subscriptions = function (_p0) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Ports$localStorageRetrievedItem(
				function (_p1) {
					return _user$project$Types$Auth(
						_user$project$Types$AuthTokenRetrievedFromLocalStorage(_p1));
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Ports$formImageRetrieved(
					function (_p2) {
						return _user$project$Types$Share(
							_user$project$Types$FormImageRead(_p2));
					}),
				_1: {
					ctor: '::',
					_0: _user$project$Ports$statusPosted(
						function (_p3) {
							return _user$project$Types$Share(
								_user$project$Types$StatusPosted(_p3));
						}),
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$Main$init = function (url) {
	if (A2(_elm_lang$core$String$startsWith, '#user:', url.hash)) {
		var userId = A2(_elm_lang$core$String$dropLeft, 6, url.hash);
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				_user$project$Model$initialModel,
				{
					screenShown: _user$project$Types$User(userId)
				}),
			_1: _user$project$Auth$checkAuthToken
		};
	} else {
		if (A2(_elm_lang$core$String$startsWith, '#photo:', url.hash)) {
			var _p4 = _user$project$Update$photoHashParts(url.hash);
			if (_p4.ctor === 'Ok') {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			if (_elm_lang$core$Native_Utils.eq(url.hash, '#home')) {
				...
				if (_elm_lang$core$Native_Utils.eq(url.hash, '#me')) {
					...
					if (A2(_elm_lang$core$String$startsWith, '#share:', url.hash)) {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								_user$project$Model$initialModel,
...
var _user$project$Main$main = A2(
	...
	_user$project$Types$UrlHasChanged,
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Types.StatusId":{"args":[],"tags":{"StatusId":["String"]}},"Types.Msg":{"args":[],"tags":{"CloseMessage":[],"Share":["Types.ShareMsg"],"Auth":["Types.AuthMsg"],"TimelineFetched":["Result.Result Http.Error (List Types.Status)"],"ViewPhoto":["Types.Status","Types.Attachment"],"UrlHasChanged":["Navigation.Location"],"PhotoFetched":["Result.Result Http.Error Types.Status"]}},"Types.AttachmentType":{"args":[],"tags":{"Image":[],"Unknown":[],"Video":[],"Gifv":[]}},"Types.AuthMsg":{"args":[],"tags":{"Logout":[],"AuthReturn":["Result.Result Http.Error Types.AuthResponse"],"ServerSelect":["String"],"AuthTokenRetrievedFromLocalStorage":["( String, Maybe.Maybe String )"],"AuthSubmit":[],"Password":["String"],"UserEmail":["String"],"UserDetailsFetched":["Result.Result Http.Error Types.Account"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Types.ShareMsg":{"args":[],"tags":{"UploadImage":[],"FormImageRead":["Types.ImagePortData"],"ShareTextInput":["String"],"ShareImage":[],"StatusPosted":["Maybe.Maybe String"],"ImageShared":["Result.Result Http.Error String"],"ImageSelected":[]}},"Types.AttachmentId":{"args":[],"tags":{"AttachmentId":["String"]}}},"aliases":{"Types.Attachment":{"args":[],"type":"{ id : Types.AttachmentId , type_ : Types.AttachmentType , url : String , previewUrl : String }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Types.ImagePortData":{"args":[],"type":"{ contents : String, filename : String }"},"Types.Status":{"args":[],"type":"{ id : Types.StatusId , url : Maybe.Maybe String , account : Types.Account , content : Maybe.Maybe String , attachments : List Types.Attachment }"},"Types.Account":{"args":[],"type":"{ id : String, acct : String, displayName : String }"},"Types.AuthResponse":{"args":[],"type":"{ token : String }"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Types.Msg"},"versions":{"elm":"0.18.0"}});
}
