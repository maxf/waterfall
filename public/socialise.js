...
var _user$project$Model$Status = F3(
	function (a, b, c) {
		return {id: a, url: b, content: c};
	});
var _user$project$Model$Model = F5(
	function (a, b, c, d, e) {
		return {authToken: a, username: b, password: c, message: d, timeline: e};
	});
var _user$project$Model$initialModel = A5(
...
var _user$project$Update$getTimeline = function (authToken) {
...
var _user$project$Update$authenticate = F2(
	function (username, password) {
		var postParams = A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$http$Http$encodeUri(username),
				A2(
					_elm_lang$core$Basics_ops['++'],
					'&password=',
					_elm_lang$http$Http$encodeUri(password))));
		var request = A3(
		...
		switch (_p0.ctor) {
			...
			case 'AuthSubmit':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Update$authenticate, model.username, model.password)
				};
			case 'AuthReturn':
				if (_p0._0.ctor === 'Ok') {
					var _p1 = _p0._0._0;
					return {
						...
						_1: _user$project$Update$getTimeline(_p1.token)
					};
				} else {
					return {
						ctor: '_Tuple2',
...
var _user$project$View$viewTimelineItem = function (status) {
	return A2(
		_elm_lang$html$Html$li,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(status.content),
			_1: {ctor: '[]'}
		});
};
var _user$project$View$viewTimeline = function (timeline) {
	return A2(
		...
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$View$viewTimelineItem, timeline));
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Update.Msg":{"args":[],"tags":{"AuthReturn":["Result.Result Http.Error Update.AuthResponse"],"TimelineFetched":["Result.Result Http.Error (List Model.Status)"],"Username":["String"],"AuthSubmit":[],"Password":["String"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Update.AuthResponse":{"args":[],"type":"{ token : String }"},"Model.Status":{"args":[],"type":"{ id : String, url : String, content : String }"}},"message":"Update.Msg"},"versions":{"elm":"0.18.0"}});
}
