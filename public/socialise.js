				...
				if (A2(_elm_lang$core$String$startsWith, '#user:', url.hash)) {
					...
					if (A2(_elm_lang$core$String$startsWith, '#upload', url.hash)) {
						...
						if (A2(_elm_lang$core$String$startsWith, '#photo', url.hash)) {
							var _p11 = _user$project$Update$photoHashParts(url.hash);
							if (_p11.ctor === 'Ok') {
								return A2(_user$project$Types$Photo, _p11._0._0, _p11._0._1);
							} else {
	...
	function (msg, model) {
		...
		switch (_p12.ctor) {
			...
			case 'ServerSelect':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Model$changeServerUrl, model, _p12._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AuthSubmit':
				return {
				...
				if (_p12._0.ctor === 'Nothing') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								message: _elm_lang$core$Maybe$Just(_p12._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							screenShown: _user$project$Types$ShareUpload(
								_elm_lang$core$Maybe$Just(_p12._0.contents))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ImageShared':
							...
							model,
							{
								message: _elm_lang$core$Maybe$Just(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'share error: ',
										_user$project$Update$httpErrorMessage(_p12._0._0)))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
				...
				if (_p12._0.ctor === 'Ok') {
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								authToken: _elm_lang$core$Maybe$Just(_p13.token),
								message: _elm_lang$core$Maybe$Nothing
							}),
						{
							ctor: '::',
							_0: _user$project$Auth$storeAuthToken(_p13.token),
							_1: {
								ctor: '::',
								_0: A2(_user$project$Update$getUser, _p13.token, model.server.url),
								_1: {ctor: '[]'}
							}
						});
				} else {
				...
				if (_p12._0.ctor === 'Err') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								username: _p14.acct,
								userId: _elm_lang$core$Maybe$Just(_p14.id)
							}),
				...
				if (_p12._0.ctor === 'Err') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								currentStatus: _elm_lang$core$Maybe$Just(_p12._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			case 'AuthTokenRetrieved':
				...
				if (_p15.ctor === 'Nothing') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{authToken: _p16, password: ''}),
						_1: A2(_user$project$Update$getUser, _p15._0, model.server.url)
					};
				}
			case 'ViewPhoto':
				var _p18 = _p12._0;
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							screenShown: A2(_user$project$Types$Photo, _p18.id, _p17.id)
						}),
					_1: _elm_lang$navigation$Navigation$newUrl(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$Types$statusIdToString(_p18.id),
								A2(
									_elm_lang$core$Basics_ops['++'],
									':',
									_user$project$Types$attachmentIdToString(_p17.id)))))
				};
			case 'Logout':
				return {
					ctor: '_Tuple2',
